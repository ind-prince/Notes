...
// Security
// Insights
// JavaScriptCourseByThapaTechnical/index.js /
// @thapatechnical
// thapatechnical index file added
// Latest commit cade07b on Jan 11, 2021
//  History
//  1 contributor
// 2809 lines (1570 sloc)  61.3 KB
...
// for(value in myFriends){
//   console.log(value)
// }

// for(value of myFriends){
//   console.log(value)
// }
...
// console.log(myFriendNames.lastIndexOf("thapa", 2));
...
// // price < 400
// const findElem = prices.find((x) =>  x < 400 );
...
// // sol1: 
// const newMonth = months.splice(0,3,"Dec");
// console.log(months);
...
// if(indexOfMonth != -1){
//   const updateMonth = months.splice(indexOfMonth,1,'replace month');
//   console.log(months);
// }else{
...
// Array.prototype.map() 🙋‍♂️ gives answer
...
// let newArr = array1.map((curElm, index, arr) => {
//     return `Serial no = ${index+1} and the value is ${curElm} belong to ${arr} `
// });
// console.log(newArr);
...
//  let arr2 = arr.map((curElm) => curElm * 2);
...
// let str = "HELLO WORLD";
// let name = 'princr singh'

// let lastChar = str.length-2
...
// // let d = new Date(2023, 0, 7, 14, 55, 59);
// console.log(d.toLocaleString());
// console.log(d);
...
// console.log(Math.min(0, 150, 30, 20, -8, -2));
...
// console.log(Math.round(Math.random()*10000)); // 0 to 9
...
// Blog
// About
// JavaScriptCourseByThapaTechnical/index.js at main · thapatechnical/JavaScriptCourseByThapaTechnical · GitHub
